...
<body>
  ...
  <h1 style="margin: 10px 50px;">用藥時間</h1>
  <form method="POST" action="nurse_med_time2.php">
    <div class="border_1">
      <table id="info">
        <tr>
        ...
        <tr>
          <td>
            <input type="checkbox" value='FUROSELY TABLETS "M.S."(高血壓)' name="Product_1"> FUROSELY TABLETS "M.S."(高血壓)<br>
            <input type="checkbox" value="FURSEDE TABLETS(高血壓)" name="Product_2"> FURSEDE TABLETS(高血壓)<br>
            <input type="checkbox" value='SHIN TAN TABLETS "SHOU CHAN"(糖尿病)' name="Product_3"> SHIN TAN TABLETS "SHOU CHAN"(糖尿病)<br>
        </select></td>
          <td>
            <div id="show_time">  
              <script> 
