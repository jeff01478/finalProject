...
<body>
  ...
  <h1 style="margin: 10px 50px;">查房時間</h1>

  <form method="POST" action="nurse_ward_round2.php">
  <div class="border_1">
    <table id="info">
      <tr>
      ...
      <tr>
        <td>
          <input type="checkbox" value="量血壓" name="Product_1"> 量血壓<br>
          <input type="checkbox" value="量體溫" name="Product_2"> 量體溫<br>
          <input type="checkbox" value="醫生診問" name="Product_3"> 醫生診問<br>
          <input type="checkbox" value="換藥" name="Product_4"> 換藥<br>
        </td>
        <td>
          <div id="show_time">  
            <script>  
